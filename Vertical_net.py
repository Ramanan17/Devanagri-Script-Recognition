# -*- coding: utf-8 -*-
"""
Created on Sun Apr  7 11:55:03 2019
...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr  7 11:52:32 2019
...
def convert_to_one_hot(Y, C):
    ...
    return Y
#%%
filelist=os.listdir('..\matras\Vertical')
Training_images  =[] 
labels=[]
labels2 =[]
i=0
for const in filelist:
    pics = os.listdir('..\matras\Vertical\{}'.format(const))
    i=i+1 
    for pic in pics:
        image = Image.open('..\matras\Vertical\{}\{}'.format(const,pic))
...
#%%
with open('Vertical_net', 'wb') as fp:
     pickle.dump(weigh, fp)
with open ('Vertical_net', 'rb') as fp:
